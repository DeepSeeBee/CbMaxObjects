...
namespace CbMaxClrAdapter
{
    ...
    public abstract class CInlet : CConnector
    {
        ...
        internal abstract void Receive(CMessage aMessage);
    ...
    public abstract class CInlet<TMessage> : CInlet where TMessage : CMessage
    {
        ...
        internal override void Receive(CMessage aMessage) => this.Receive((TMessage)aMessage);
        internal virtual void Receive(TMessage aMessage) => this.Action(this, aMessage);
    }
